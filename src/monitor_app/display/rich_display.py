# monitor_app/display/rich_display.py #
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
"""
rich_display.py  —  Live terminal dashboard for monitor_app training runs.
...
This module does NOT modify any existing monitor_app functionality; it only
...
class TrainingDisplay:
    """
    Real-time Rich terminal dashboard for monitor_app training sessions.
    ...
    def _header(self) -> Panel:
        ...
        markup = (
            f"[bold cyan]monitor_app[/bold cyan]  "
